...
public static class Registry
{
    ...
    [
        ...
        new("collision-hazard-proximity", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.CollisionHazardProximity.Locator]),
        new("reasonable-protection", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.ReasonableProtection.Locator]),
        ...
        new("flash-rate-sufficient", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.FlashRateSufficient.Locator]),
        new("intensity-reduction-in-interest-of-safety", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.IntensityReductionInInterestOfSafety.Locator]),
        ...
        new("unaided-visual-contact", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.UnaidedVisualContact.Locator]),
        new("visual-observer-conditions", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.VisualObserverConditions.Locator]),
        new("effective-communication", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.EffectiveCommunication.Locator]),
        new("observer-coordination", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.ObserverCoordination.Locator]),
        new("preflight-actions", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.PreflightActions.Locator]),
        new("preflight-risk-assessment", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.PreflightRiskAssessment.Locator]),
        new("participant-briefing", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.ParticipantBriefing.Locator]),
        new("control-links-working", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.ControlLinksWorking.Locator]),
        new("sufficient-available-power", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.SufficientAvailablePower.Locator]),
        new("attached-object-secure", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.AttachedObjectSecure.Locator]),
        new("attached-object-no-adverse-effect", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.AttachedObjectNoAdverseEffect.Locator]),
