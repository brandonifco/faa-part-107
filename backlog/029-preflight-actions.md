...
Backlog item 29 of 29 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`sufficient-available-power`](026-sufficient-available-power.md)
- [`attached-object-secure`](027-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](028-attached-object-no-adverse-effect.md)
