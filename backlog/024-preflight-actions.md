...
Backlog item 24 of 24 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](020-preflight-risk-assessment.md)
- [`participant-briefing`](021-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- `sufficient-available-power` -- no backlog item (status: implemented)
- [`attached-object-secure`](022-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](023-attached-object-no-adverse-effect.md)
