...
Backlog item 21 of 21 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`attached-object-secure`](019-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](020-attached-object-no-adverse-effect.md)
