...
Backlog item 22 of 22 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](018-preflight-risk-assessment.md)
- [`participant-briefing`](019-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- `sufficient-available-power` -- no backlog item (status: implemented)
- [`attached-object-secure`](020-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](021-attached-object-no-adverse-effect.md)
