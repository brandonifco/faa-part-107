...
Backlog item 23 of 23 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](019-preflight-risk-assessment.md)
- [`participant-briefing`](020-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- `sufficient-available-power` -- no backlog item (status: implemented)
- [`attached-object-secure`](021-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](022-attached-object-no-adverse-effect.md)
