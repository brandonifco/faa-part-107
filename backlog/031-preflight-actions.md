...
Backlog item 31 of 31 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](026-preflight-risk-assessment.md)
- [`participant-briefing`](027-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- [`sufficient-available-power`](028-sufficient-available-power.md)
- [`attached-object-secure`](029-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](030-attached-object-no-adverse-effect.md)
