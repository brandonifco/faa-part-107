...
Backlog item 34 of 34 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](029-preflight-risk-assessment.md)
- [`participant-briefing`](030-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- [`sufficient-available-power`](031-sufficient-available-power.md)
- [`attached-object-secure`](032-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](033-attached-object-no-adverse-effect.md)
