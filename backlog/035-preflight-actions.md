...
Backlog item 35 of 35 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](030-preflight-risk-assessment.md)
- [`participant-briefing`](031-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- [`sufficient-available-power`](032-sufficient-available-power.md)
- [`attached-object-secure`](033-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](034-attached-object-no-adverse-effect.md)
