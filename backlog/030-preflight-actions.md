...
Backlog item 30 of 30 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](025-preflight-risk-assessment.md)
- [`participant-briefing`](026-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- [`sufficient-available-power`](027-sufficient-available-power.md)
- [`attached-object-secure`](028-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](029-attached-object-no-adverse-effect.md)
