...
Backlog item 26 of 26 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](022-preflight-risk-assessment.md)
- [`participant-briefing`](023-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- `sufficient-available-power` -- no backlog item (status: implemented)
- [`attached-object-secure`](024-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](025-attached-object-no-adverse-effect.md)
