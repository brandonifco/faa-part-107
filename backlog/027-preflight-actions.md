...
Backlog item 27 of 27 for FaaPart107, from RulesFactory.Maps.FaaPart107 4.0.0. Generated by `factory produce` from the map merged with `corpus-map.overlay.json`; change those, not this file.
...
- [`preflight-risk-assessment`](023-preflight-risk-assessment.md)
- [`participant-briefing`](024-participant-briefing.md)
- `control-links-working` -- no backlog item (status: implemented)
- `sufficient-available-power` -- no backlog item (status: implemented)
- [`attached-object-secure`](025-attached-object-secure.md)
- [`attached-object-no-adverse-effect`](026-attached-object-no-adverse-effect.md)
